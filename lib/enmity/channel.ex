defmodule Enmity.Channel do
  ...
  def get(channel_id) do
    HTTP.get("/channels/#{channel_id}") |> HTTP.make_response_nicer()
  end
  ...
  def modify(channel_id, opts) do
    ...
    HTTP.patch("/channels/#{channel_id}", opts) |> HTTP.make_response_nicer()
  end

  def delete(channel_id) do
    HTTP.delete("/channels/#{channel_id}") |> HTTP.make_response_nicer()
  end

  def get_messages(channel_id) do
    HTTP.get("/channels/#{channel_id}/messages") |> HTTP.make_response_nicer()
  end

  def get_message(channel_id, message_id) do
    HTTP.get("/channels/#{channel_id}/messages/#{message_id}") |> HTTP.make_response_nicer()
  end
  ...
  def create_message(channel_id, content, opts \\ []) do
    ...
    HTTP.post("/channels/#{channel_id}/messages", payload) |> HTTP.make_response_nicer()
  end

  def react(channel_id, message_id, emoji) do
    HTTP.put("/channels/#{channel_id}/messages/#{message_id}/reactions/#{emoji}/@me") |> HTTP.make_response_nicer()
  end

  def get_reactions(channel_id, message_id, emoji) do
    HTTP.get("/channels/#{channel_id}/messages/#{message_id}/reactions/#{emoji}") |> HTTP.make_response_nicer()
  end

  def delete_all_reactions(channel_id, message_id) do
    HTTP.delete("/channels/#{channel_id}/messages/#{message_id}/reactions") |> HTTP.make_response_nicer()
  end
  ...
  def edit_message(channel_id, message_id, opts) do
    ...
    HTTP.patch("/channels/#{channel_id}/messages/#{message_id}", payload) |> HTTP.make_response_nicer()
  end

  def delete_message(channel_id, message_id) do
    HTTP.delete("/channels/#{channel_id}/messages/#{message_id}") |> HTTP.make_response_nicer()
  end

  def bulk_delete_messages(channel_id, message_ids) when is_list(message_ids) do
    payload = Poison.encode!(message_ids)
    HTTP.post("/channels/#{channel_id}/messages/bulk-delete", payload) |> HTTP.make_response_nicer()
  end
  ...
  def edit_permissions(channel_id, overwrite_id, opts) do
    ...
    HTTP.put("/channels/#{channel_id}/permissions/#{overwrite_id}", payload) |> HTTP.make_response_nicer()
  end

  def get_invites(channel_id) do
    HTTP.get("/channels/#{channel_id}/invites") |> HTTP.make_response_nicer()
  end
  ...
  def create_invite(channel_id, opts \\ []) do
    ...
    HTTP.post("/channel/#{channel_id}/invites", payload) |> HTTP.make_response_nicer()
  end

  def delete_permission(channel_id, overwrite_id) do
    HTTP.delete("/channels/#{channel_id}/permissions/#{overwrite_id}") |> HTTP.make_response_nicer()
  end
  ...
  def get_pinned_messages(channel_id) do
    HTTP.get("/channels/#{channel_id}/pinned") |> HTTP.make_response_nicer()
  end
  ...
  def group_dm_add_recipient(channel_id, user_id, access_token, nick) do
    ...
    HTTP.put("/channels/#{channel_id}/recipients/#{user_id}", payload) |> HTTP.make_response_nicer()
  end

  def group_dm_remove_recipient(channel_id, user_id) do
    HTTP.delete("/channels/#{channel_id}/recipients/#{user_id}") |> HTTP.make_response_nicer()
  end
end
